...
namespace ToDoProject.Web.Controllers
{
    ...
    public class TaskController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,UserId,TaskDate,TaskName,TaskDescription")] Models.Task task)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,UserId,TaskDate,TaskName,TaskDescription")] Models.Task task)
        {
            if (id != task.Id)
            {
                return NotFound();
